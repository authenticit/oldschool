...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Faq') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('faq.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('faq.create')}}">{{ __('Add New Faq') }}</a></li>
    </ol>
    </div>
</div>
