...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
		<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Instructor') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('instructor.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
			<li class="breadcrumb-item"><a href="{{route('instructor.index')}}">{{ __('Manage Instructors') }}</a></li>
			<li class="breadcrumb-item"><a href="{{route('instructor.create')}}">{{ __('Add New Instructor') }}</a></li>
		</ol>
	</div>
</div>
	...
	<div class="col-lg-12">
		...
		<div class="card mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold text-primary">{{ __('Add New Instructor Form') }}</h6>
			</div>

			<div class="card-body">
				<form action="{{ route('instructor.store') }}" method="POST" enctype="multipart/form-data" novalidate>
					...
					<div class="container pl-0 pr-0 ml-0 mr-0 w-100 mw-100">
						<div id="tabs">
							<ul class="nav nav-pills nav-justified mb-3" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link out" data-toggle="pill" href="#out">{{ __('Social information') }}</a>
								</li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
								<div id="basic" class="container tab-pane active"><br>
									...
									<div class="row">
										...
										<div class="col-lg-9">
											<input type="text" class="input-field" name="name" placeholder="{{ __('Full Name') }}" required="" value="">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-9">
											<input type="text" class="input-field" name="instructor_name" placeholder="{{ __('Instructor Name') }}" required="" value="">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-9">
											<textarea name="bio" class="input-field summernote" placeholder="{{ __('Biography') }}" cols="30" rows="10" required></textarea>
										</div>
									</div>
									...
									<div class="row mt-3">
										<div class="col-lg-3">
											<div class="left-area">
												<h4 class="heading">{{ __('Instructors image') }} *</h4>
											</div>
										</div>
										<div class="col-lg-9">
								...
								<div id="req" class="container tab-pane"><br>
									...
									<div class="row">
										...
										<div class="col-lg-9">
											<input type="text" class="input-field" name="email" placeholder="{{ __('Email') }}" required="" value="">
										</div>
									</div>
									...
									<ul class="list-inline mt-3 mb-0  text-center">
										...
										<li class="list-inline-item">
											<a href="javascript:;" data-href=".out" class="next-prev btn btn-primary"> {{ __('Next') }} </a>
										</li>
									</ul>
								...
								<div id="out" class="container tab-pane"><br>
									...
									<div class="row">
										...
										<div class="col-lg-9">
											<input type="text" class="input-field" name="facebook_url" placeholder="{{ __('Facebook') }}"  value="">
										</div>
									</div>
									<div class="row">
										<div class="col-lg-3">
										...
										<div class="col-lg-9">
											<input type="text" class="input-field" name="twitter_url" placeholder="{{ __('Twitter') }}"  value="">
										</div>
									</div>
									<div class="row">
										<div class="col-lg-3">
										...
										<div class="col-lg-9">
											<input type="text" class="input-field" name="linkedin_url" placeholder="{{ __('Linkedin') }}"  value="">
										</div>
									</div>
									...
									<ul class="list-inline mt-3 mb-0  text-center">
										<li class="list-inline-item">
											<a href="javascript:;" data-href=".req" class="next-prev btn btn-primary"> {{ __('Prev') }} </a>
										</li>
									</ul>
