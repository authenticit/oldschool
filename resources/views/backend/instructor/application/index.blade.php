...
@section('content')
    <div class="card">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Applications') }}</h5>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">{{ __('Instructor') }}</a></li>
                <li class="breadcrumb-item"><a
                        href="{{ route('instructor.application') }}">{{ __('Request Application') }}</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __("Applicant details
                    			") }}</h5>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var table = $('#geniustable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('instructor.application.data-tables') }}',
            columns: [
        ...
        // instructor application details js
        ...
        // instructor application details js emd
    </script>@endsection
