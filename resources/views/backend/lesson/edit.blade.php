                ...
                <div class="card-body">
                    <form action="{{ route('lesson.update', $lesson->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="wrapper-image-preview">
                                <div class="box">
                                    ...
                                    <div class="upload-options">
                                        ...
                                        <input value="{{$lesson->file}}" id="img-upload-1" type="file" class="image-upload" name="file" accept="image/*">
                                    </div>
                                </div>
                            </div>
                            @if ($errors->has('file'))
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$lesson->title}}" type="text" class="form-control" placeholder="Title" id="name" name="title">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group form-float">
                            ...
                            <select id="section_id" name="section_id" class="form-control">
                                <option value="{{$lesson->section->id}}">{{$lesson->section->title}}</option>
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$lesson->duration}}" type="text" class="form-control" placeholder="00:00" id="name" name="duration">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="text" value="{{$lesson->pos}}" class="form-control" placeholder="0" id="name" name="pos">
                            @if ($errors->has('pos'))
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$lesson->iframe_code}}" type="text" class="form-control" placeholder="0" id="name" name="iframe_code">
                        ...
                        <div class="form-group form-float">
                                <label>Details</label>
                                <textarea class="input-field" name="details" placeholder="{{ __('Details') }}" cols="30"
                                                    rows="10">{{$lesson->details}}</textarea>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group" id="set-picture">
                            ...
                            <div class="wrapper-image-preview">
                                <div class="box">
                                    ...
                                    <div class="upload-options">
                                        <label class="img-upload-label" for="img-upload-1"> <i class="fas fa-camera"></i> {{ __('Upload Picture') }} </label>
                                        <input value="{{$lesson->video_file}}" id="img-upload-1" type="file" class="image-upload" name="video_file" accept="image/*">
                                    </div>
                                </div>
                            </div>
