    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h2><strong>BlogCategory</strong> Create </h2>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h2><strong>BlogCategory</strong> List </h2>
                    </div>
                    <div class="card-body">
                        <div class="body">
                                ...
                                <table id="exhibition_table" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>
												<a href="{{ route('blog-category.edit', $c->id) }}" class="btn btn-primary btn-sm">Edit</a>
												<form action="{{ route('blog-category.destroy', $c->id) }}" method="POST" style="display: inline-block;">
													@csrf
													@method('DELETE')
