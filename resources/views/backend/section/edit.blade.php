        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h2><strong>Section</strong> Edit </h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('section.update', $section->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$section->title}}" type="text" class="form-control" placeholder="Title" id="name" name="title">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="number" value="{{$section->pos}}" class="form-control" placeholder="0" id="pos" name="pos">
                            @if ($errors->has('pos'))
                            <span id="title_error" style="color: red">{{ $errors->first('title') }}</span>
                            @endif
                        </div>
