                    ...
                    <div class="card-body">
                        <form action="{{ route('student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                ...
                                <input value="{{$student->name}}" type="text" class="form-control" placeholder="Full Name" id="name"
                                    name="name">
                            ...
                            <div class="form-group form-float">
                                ...
                                <input value="{{$student->email}}" type="email" class="form-control" placeholder="Email" id="email"
                                    name="email">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group form-float">
                                ...
                                <textarea name="bio" id="bio" cols="30" rows="10" class="form-control">{{$student->bio}}</textarea>
                                @if ($errors->has('bio'))
                            ...
                            <label for="address">Address</label>
                                <input value="{{$student->address}}" type="text" class="form-control" placeholder="Address" id="address"
                                    name="address">
                            ...
                            <div class="form-group form-float">
                                ...
                                <input value="{{$student->phone}}" type="number" class="form-control" placeholder="Phone" id="phone"
                                    name="phone">
                                @if ($errors->has('phone'))
                            ...
                            <div class="form-group form-float">
                                ...
                                <input value="{{$student->facebook_url}}" type="text" class="form-control" placeholder="Facebook Url" id="facebook_url"
                                    name="facebook_url">
                            ...
                            <div class="form-group form-float">
                                ...
                                <input value="{{$student->twitter_url}}" type="text" class="form-control" placeholder="Twitter Url" id="twitter_url"
                                    name="twitter_url">
                            ...
                            <div class="form-group form-float">
                                ...
                                <input value="{{$student->linkedin_url}}" type="text" class="form-control" placeholder="Instagram Url" id="linkedin_url"
                                    name="linkedin_url">
