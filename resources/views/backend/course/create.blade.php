...
@section('content')
    ...
    <div class="card">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Course') }} <a class="btn btn-primary btn-rounded btn-sm"
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('course.create') }}">{{ __('Add New Course') }}</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Add New Course Form') }}</h6>
                </div>

                <div class="card-body">
                    <form action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="tab-content">
                                    <div id="basic" class="container tab-pane active"><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="input-field" name="title"
                                                    placeholder="{{ __('Course Title') }}" required="" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="input-field" name="slug"
                                                    placeholder="{{ __('Course Slug') }}" required="" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Instructor') }}</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="input-field" name="time"
                                                    placeholder="{{ __('Total Hour') }}" required="" value="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-9">
                                                <div id="requirement_area">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="">
                                                            <button type="button" class="btn btn-success btn-sm add-req">
                                    ...
                                    <div id="out" class="container tab-pane"><br>
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 pr-3">
                                                            <div class="form-group mb-1">
                                                                <input type="text" class="input-field"
                                                                    name="outcomes[]"
                                                                    placeholder="{{ __('Provide Outcomes') }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="">
                                                            <button type="button" class="btn btn-success btn-sm add-out">
                                                                <i class="fa fa-plus"></i> </button>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="list-inline mt-3 mb-0  text-center">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="javascript:;" data-href=".include"
                                                    class="next-prev btn btn-primary"> {{ __('Next') }} </a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="">
                                                            <div class="form-group mr-4">
                                                                <button class="btn btn-primary icon-picker"
                                                                    name="include_icon[]"
                                                                    data-icon="fab fa-font-awesome"></button>
                                                        ...
                                                        <div class="flex-grow-1 pr-3">
                                                            <div class="form-group mb-1">
                                                                <input type="text" class="input-field"
                                                                    name="include_text[]"
                                                                    placeholder="{{ __('Include Text') }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="">
                                                            <button type="button"
                                        ...
                                        <div class="row f-course">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="number" class="input-field f-course-field" name="price"
                                                    placeholder="{{ __('Course price') }}" value="" step="0.1"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row f-course">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="number" class="input-field f-course-field"
                                                    ...
                                                    value="" step="0.1" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="course_overview_type" class="input-field" required>
                                                    ...
                                                    <option value="Html5">{{ __('Html5') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" id="tags" class="mytags" name="meta_keywords"
                                                    placeholder="{{ __('Meta Keywords') }}" value="">
                                            </div>
                                        </div>
