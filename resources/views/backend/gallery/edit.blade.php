                ...
                <div class="card-body">
                    <form action="{{ route('gallery.update', $image->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            <label>Title</label>
                            <input type="text" class="form-control" placeholder="ie: First Plantation" id="title" name="title" title="Please enter Gallery title" value="{{ $image->title }}">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group form-float">
                            ...
                            <select class="form-control" name="artist_id" id="artist_id">
                                ...
                                <option value="{{ $artist->id }}" {{ $image->artist_id == $artist->id ? 'selected' : '' }}>{{ $artist->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <input type="text" class="form-control" placeholder="ie: 60 x 40 in" id="size_inc" name="size_inc"  value="{ $image->size_inc }">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <input type="text" class="form-control" placeholder="ie: 119.4 x 302.3 cm" id="size_cm" name="size_cm" value="{{ $image->size_cm }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <select class="form-control" name="category_id" id="category_id">
                                        ...
                                        <option value="{{ $category->id }}" {{ $image->category_id == $category->id ? 'selected' : ''}}>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <select class="form-control validate[required]" name="year" id="year">
                                        ...
                                        <option value="{{ $year }}" {{ $image->year == $year ? 'selected' : ''}}>{{ $year }}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('year'))
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <input type="text" name="copyright" id="copyright" class="form-control" placeholder="ie: S.M.Sultan"  value="{{ $image->copyright }}">
                        ...
                        <div class="form-group form-float">
                            <label>Image</label>
                            <input type="file" name="image" id="image" data-max-file-size="200K" data-height="300" data-default-file="{{ url('upload/images', $image->image)}}">
