        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h2><strong>Book</strong> Update </h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group" id="set-picture">
                            ...
                            <div class="wrapper-image-preview">
                                <div class="box">
                                    <div class="back-preview-image" style="background-image: url({{ url('uploads/images/book', $book->image) }});"></div>
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$book->name}}" type="text" class="form-control" placeholder="Book Name" id="name" name="name">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group form-float">
                            ...
                            <select id="book_category_id" name="book_category_id" class="form-control">
                                <option selected value="{{$book->bookCategory->id}}"> {{ $book->bookCategory->name }}</option>
                        ...
                        <div class="form-group form-float">
                            ...
                            <select id="instructor_id" name="instructor_id" class="form-control">
                                <option selected value="{{$book->user->id}}">{{ $book->user->name }}</option>
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$book->actual_price}}" type="number" class="form-control" placeholder="Actual Price" id="actual_price" name="actual_price">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$book->sale_price}}" type="number" class="form-control" placeholder="Sale Price" id="sale_price" name="sale_price">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input value="{{$book->instructor_percentage}}" step="0.1" type="number" class="form-control" placeholder="Instructor Percentage" id="instructor_percentage" name="instructor_percentage">
                        ...
                        <div class="form-group form-float">
                            ...
                            <textarea name="description" class="input-field summernote" placeholder="{{ __('Description') }}" cols="30" rows="10">{{$book->description}}</textarea>
                        ...
                        <!-- <div class="form-group form-float mt-2">
                            <label>Image</label>
                            <input type="file" name="image" id="image" data-max-file-size="700K" data-height="200">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="tags" class="mytags" name="meta_keywords" placeholder="{{ __('Meta Keywords') }}" value="{{$book->meta_keywords}}">
                        ...
                        <div class="form-group form-float">
                            ...
                            <textarea name="meta_description" class="input-field summernote" placeholder="{{ __('meta_description') }}" cols="30" rows="10">{{$book->meta_description}}</textarea>
                            @if ($errors->has('bio'))
                        ...
                        <!-- <div class="form-group form-float mt-2">
                            ...
                            <input type="file" name="meta_image" id="meta_image" data-max-file-size="700K" data-height="200">
                            <small>Image size must be 825px X 366px</small><br>
                        ...
                        <div class="form-group" id="set-picture">
                            ...
                            <div class="wrapper-image-preview">
                                <div class="box">
                                    <div class="back-preview-image" style="background-image: url({{ url('uploads/images/book', $book->meta_image) }});"></div>
                                    <div class="upload-options">
