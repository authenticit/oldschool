    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h2><strong>Google Settings</strong> Create </h2>
        </div>
        <div class="card-body">
          <form action="{{ route('google.store') }}" method="POST">
            ...
            <div class="form-group">
              ...
              @else
              <input name="client_id" type="text" class="input-field" placeholder="{{ __('Enter App ID') }}" required="">
              @endif
            </div>
            ...
            <div class="form-group">
              ...
              @else
              <input name="client_secret" type="text" class="input-field" placeholder="{{ __('Enter App Secret') }}" required="">
              @endif
            </div>
            ...
            <a href="{{ route('google.edit', $google->id) }}">
            <button type="button" name="action_button" id="action_button" class="btn btn-success waves-effect">Update</button>
            </a>
          </form>
        </div>
      </div>
