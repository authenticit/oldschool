...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New User') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('users.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
    <ol class="breadcrumb">
            ...
            <div class="tab-content">
              <div id="basic" class="container tab-pane active"><br>
                <div class="row">
                    ...
                    <div class="col-lg-9">
                      <input type="text" class="input-field" name="name" placeholder="Full Name" value="">
                    </div>
                </div>
