...
@section('content')
    ...
    <div class="card">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit User') }} <a class="btn btn-primary btn-rounded btn-sm"
                    href="{{ route('users.index') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
            <ol class="breadcrumb">
    ...
    <div class="row justify-content-center mt-3">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="gocover" style="background: url() no-repeat scroll center center rgba(45, 45, 45, 0.5);">
                    </div>
                                    ...
                                    <div id="basic" class="container tab-pane active"><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="status" id="" class="input-field">
                                                    ...
                                                    <option value="2"
                                                        @if ($user->status == 2) selected @endif>In-Active</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="list-inline mt-3 mb-0  text-center">
                                            <li class="list-inline-item">
                                                <a href="javascript:;" data-href=".req" class="next-prev btn btn-primary">
                                                    {{ __('Next') }} </a>
                                            </li>
                                        </ul>
