            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form id="loginform" action="{{ route('login') }}" method="POST" class="user">
                    @csrf
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small" id="remember" style="">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="font-weight-bold small" href="">{{ __('Forgot Password!') }}</a>
                  </div>
                  <div class="text-center">
                  </div>
                </div>
