                ...
                <ul>
                    <li>
                        ...
                        @else
                            ...
                            <a href="{{ route('artist.login') }}" class="btn btn-success"
                                title="Exibitions">Artist Login</a>
                        @endif
                    </li>
                    ...
                    <li class="ui dropdown">
                        ...
                        <div class="menu dropdown_account">
                            <div class="channel_my">
                                ...
                                <!-- if user role is artist then show artist profile -->
                                @if (Auth::check() && Auth::user()->role == 'user')
                                    
                                <a href="{{ route('student-profile') }}" class="dp_link_12">View Profile</a>
                                @endif

                                <a href="{{ route('change.password') }}" class="dp_link_12">Change Password</a>
        ...
        <div class="left_section menu_left" id="js-menu">
            <div class="left_section">
                <ul>
                    ...
                    <li class="menu--item">
                        <a href="{{ route('artist.exhibition') }}" class="menu--link"
                            title="Exibitions">
                            <i class='uil uil-home-alt menu--icon'></i>
                            <span class="menu--label">Exhibitions</span>
                        </a>
                    </li>
                    @if (Auth::check('phone') && Auth::user()->role == 'artist')
                    <li class="menu--item">
                    <a href="{{ route('artist.profile') }}" class="menu--link">
                        <i class='uil uil-kayak menu--icon'></i>
                        <span class="menu--label">Artist Profile</span>
                    </a>
                        
                    </li>
                    @else
                    <li class="menu--item">
                        <a href="{{ route('artist.login') }}" class="menu--link" title="Explore">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('artist.dashboard') }}" class="menu--link" title="Saved Courses">
                    ...
                    <li class="menu--item">
                        <a href="{{ route('artist.gallery') }}" class="menu--link" title="Saved Courses">
                            <i class="uil uil-heart-alt menu--icon"></i>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="item_f3">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.gainsgroup.app">
                                <img src="{{ asset('assets/frontend/playstore.webp') }}" alt="" class="mt-2" width="180vh">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12">
