				...
				<div class="row">
					<div class="col-lg-12">
						<div class="course_tabs">
							<nav>
								<div class="nav nav-tabs help_tabs tab_crse justify-content-center" id="nav-tab"
									role="tablist">
									<a class="nav-item nav-link active" id="nav-instructor-tab" data-toggle="tab"
										href="#nav-instructor" role="tab" aria-selected="true">Instructor</a>
									<a class="nav-item nav-link" id="nav-student-tab" data-toggle="tab"
										href="{{ route('help') }}" role="tab" aria-selected="false">Student</a>
								</div>
							</nav>
						</div>
					</div>
												...
												<div class="col-md-4">
													<a href="#" class="value_props50">
														...
														<div class="value_content">
															<h4>Payments</h4>
															<p>Understand the revenue share and how to receive payments.
															</p>
														</div>
													</a>
												</div>
