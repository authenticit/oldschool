					...
					<div class="course_tabs">
						<nav>
							<div class="nav nav-tabs tab_crse  justify-content-center">
								...
								<a class="nav-item nav-link active" href="{{ route('career') }}">Careers</a>
								<a class="nav-item nav-link" href="press.html">Press</a>
							</div>
						</nav>
					</div>
					<div class="title129 mt-35 mb-35">
						<h2>We're a passionate, creative, and global company, come work with us.</h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="title484">
						...
						<p>Phasellus ex mauris, rhoncus quis posuere sit amet, ultricies nec lorem. Vivamus
							vestibulum porta urna, in placerat lectus facilisis sit amet. Vestibulum non mauris
							augue. Maecenas arcu magna, aliquam imperdiet tempor nec, lobortis ac erat. Aliquam vel
							magna tortor. Cras ornare, enim eu tristique tristique, orci nisl blandit mi, at
							dignissim velit leo nec metus.</p>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section3125">
							<div class="la5lo1">
								<div class="owl-carousel feature_careers owl-theme">
									<div class="item">
										<div class="career_item">
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget
												enim in turpis consequat tempor sed id neque. Nam at felis et elit
												auctor accumsan. Nunc at tortor tellus. Cras dignissim velit velit,
												ac sollicitudin mi bibendum in. In vel nibh sodales, venenatis eros
												a, vulputate ligula.</p>
										</div>
									</div>
									<div class="item">
										<div class="career_item">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="title589 text-center">
						<h2>Benefits</h2>
						<p>Cursus culture is something special, and to complement and support that culture we have
							some amazing benefits.</p>
						<img class="line-title" src="images/line.svg" alt="">
					</div>
				</div>
				<div class="col-lg-3  col-sm-6">
					<div class="feature125">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget enim in turpis
							consequat tempor sed id neque. Nam at felis et elit auctor accumsan.</p>
					</div>
				</div>
				<div class="col-lg-3  col-sm-6">
					<div class="feature125">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="title589 mb-20 text-center">
						<h2>Open Roles</h2>
						<p>Cursus is a fast growing company and we're expanding both our Punjab office and
				...
				<div class="col-lg-6">
					<div class="apply_job_link mt-30">
						...
						<div class="apply_job_link_right">
							<a href="apply_job.html" class="career_lnk5">Learn More and Apply</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
