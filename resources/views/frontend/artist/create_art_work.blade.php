        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 min_h_100">
                <div class="setting_content bg_default h-100">
                    ...
                    <form action="{{ route('artist.add.artwork') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="profile">
                                ...
                                {{-- <div class="form-group text-center img_preview">
                                    @if ($artist->image)
                                    <img src="{{ url('/images/artist/profile', $artist->image) }}" alt="art work">
                                    @else
                                    <img src="{{ asset('assets/frontend/artist/images/ss.png') }}" alt="admin">
                                    @endif
                                </div> --}}
                                <div class="form-group text-center">
                                    <label for="image" class="change_img btn btn-info">Upload image</label>
                                    <input name="image" required class="d-none" type="file" id="image" accept=".png, .gif, .jpeg, .jpg" onChange="multiThumUrl(this)">
                                    <img src="" id="multiThmb" >
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="media" class="form-control" id="">
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="year" class="form-control" id="" required>
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
										<textarea class="form-control" name="description" id="address" rows="3"></textarea>
                                    </div>
                                </div>
