          ...
          <div class="right-content">
            <ul class="nav" id="pills-tab" role="tablist">
              <li class="nav-item login">
                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="false"><i class="fas fa-lock"></i>
                  @if($student->phone == '')
                  {{__('Vefiry Email Number')}}
                  @elseif($student->email == '')
                  {{__('Vefiry Phone Number')}}
                  @endif
                </a>
              </li>
              ...
              <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="login-area">
                  <div class="login-form signin-form">
                    ...
                    <form id="verifyForm" action="{{ route('student.verify.submit') }}"  method="POST">
                      {{ csrf_field() }}
